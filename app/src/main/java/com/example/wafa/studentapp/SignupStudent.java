...
public class SignupStudent extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentName = (EditText) findViewById( R.id.usernamesignup);
        studentEmail= (EditText) findViewById(R.id.emailsignup);
        studentPassword = (EditText) findViewById(R.id.passsignup);
        studentPhone = (EditText) findViewById(R.id.phonesignup);
